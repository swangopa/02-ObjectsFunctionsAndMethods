...
def try_functions():
    ...
    sally.pen_up()
    sally.go_to(rg.Point(200,100))
    sally.pen_down()
    sally.go_to(rg.Point(300,30))

    sally = rg.SimpleTurtle()
    sally.pen_up()
    sally.go_to(rg.Point(100, 200))
    sally.pen_down()
    sally.go_to(rg.Point(0, 0))

    sally = rg.SimpleTurtle()
    sally.pen_up()
    sally.go_to(rg.Point(-50, 50))
    sally.pen_down()
    sally.go_to(rg.Point(100, 100))
